...
#-----Hyprland-----#
if [-d ~/.config/hypr]; then mv ~/.config/hypr ~/.config/hypr.backup
fi 
mv ~/asexy_dots/hypr ~/.config/hypr
echo "Hyprland config installed"
#-----Waybar-----#
if [-d ~/.config/waybar]; then mv ~/.config/waybar ~/.config/waybar.backup
fi
mv ~/asexy_dots/waybar ~/.config/waybar
echo "Waybar config installed"
#-----Kitty-----#
if [-d ~/.config/kitty]; then mv ~/.config/kitty ~/.config/kitty.backup
fi
mv ~/asexy_dots/kitty ~/.config/kitty
echo "Kitty config installed"
#-----Rofi-----#
if [-d ~/.config/rofi]; then mv ~/.config/rofi ~/.config/rofi.backup
fi
mv ~/asexy_dots/rofi ~/.config/rofi
echo "Rofi config installed"
#-----Mako-----#
if [-d ~/.config/mako]; then mv ~/.config/mako ~/.config/mako.backup
fi
mv ~/asexy_dots/mako ~/.config/mako
echo "Mako config installed"
#-----Wallpapers-----#
if [-d ~/Documents/wallpapers]; then mv ~/Documents/wallpapers ~/Documents/wallpapers.backup
fi
...
#-----Colours-----#
if [-d ~/.config/colours]; then mv ~/.config/colours ~/.config/colours_backup
fi
